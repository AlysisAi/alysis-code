...
_LAZY_ATTR_MODULES = {
    ...
    "_SAME_BATCH_READ_WINDOW_DEFAULT_MAX_LINES": "read_cache",
    "_SAME_BATCH_READ_CACHE_SAFE_TOOL_NAMES": "read_cache",
    "_SameBatchReadWindowRecord": "read_cache",
    "_SameBatchFsReadRecord": "read_cache",
    "_SameBatchReadReuseCache": "read_cache",
    "_build_read_window_result_from_cached_range": "read_cache",
    "_build_read_window_result_from_full_read": "read_cache",
    "_coerce_read_window_request": "read_cache",
